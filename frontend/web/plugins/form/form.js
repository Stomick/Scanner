...
(function ($) {
    $.fn.limit = function (options) {
        ...
        return this.each(function () {
            var characters = options.limit, wrapper = $('<div class="cl-textlimit" />'),
                result_class = $('<div class="cl-textlimit-result" />');
...
!function (t) {
    ...
    e.prototype = {
        constructor: e, __alterButtons: function (e, n) {
            ...
            for (i = 0; i < e.length; i++) {
                ...
                for (o = 0; o < l.length; o++) {
                    ...
                    for (c = 0; c < h.length; c++) {
                        var u = h[c], p = "", f = a + "-" + u.name, v = u.btnText ? u.btnText : "",
                            g = u.btnClass ? u.btnClass : "btn", m = u.tabIndex ? u.tabIndex : "-1";
            ...
            var n = t(e.currentTarget), i = this.$handler, a = this.$callback, r = n.attr("data-handler"),
                s = i.indexOf(r), o = a[s];
            t(e.currentTarget).focus(), o(this), r.indexOf("cmdSave") < 0 && this.$textarea.focus(), e.preventDefault()
        }, showEditor: function () {
            var e, n = this, i = this.$ns, a = this.$element, r = (a.css("height"), a.css("width"), this.$editable),
                s = this.$handler, o = this.$callback, l = this.$options, c = t("<div/>", {
            ...
            var e, n = this.$options, i = n.onPreview(this), a = this.$textarea, r = a.next(),
                s = t("<div/>", {"class": "md-preview", "data-provider": "markdown-preview"});
            ...
            if (i.hasClass("active") || 0 == this.$element.parent().length) {
                if (i.removeClass("active"), n) if (null != a.el) {
                    var r = t("<" + a.type + "/>"), s = this.getContent(),
                        o = "object" == typeof markdown ? markdown.toHTML(s) : s;
    ...
    t.fn.markdown = function (n) {
        ...
        autofocus: !1, hideable: !1, savable: !1, width: "inherit", height: "inherit", buttons: [[{
            name: "groupFont",
            data: [{
...
(function (f) {
    ...
    function p(a, c, d) {
        var b = a[0], e = a.parent(), g = c == j, H = c == k, m = H ? v : g ? I : "enabled", r = h(b, m + y(b[l])),
            L = h(b,
                c + y(b[l]));
        if (!0 !== b[c]) {
    ...
    function w(a, c, d) {
        var b = a[0], e = a.parent(), g = c == j, f = c == k, m = f ? v : g ? I : "enabled", n = h(b, m + y(b[l])),
            p = h(b, c + y(b[l]));
        if (!1 !== b[c]) {
            if (f || !d || "force" == d) b[c] =
                !1;
    ...
    var n = "iCheck",
        F = n + "-helper", x = "radio", j = "checked", I = "un" + j, u = "disabled", v = "determinate", k = "in" + v,
        E = "update", l = "type", t = "addClass", A = "removeClass", r = "trigger", D = "label", z = "cursor",
    ...
    f.fn[n] = function (a, c) {
        ...
        if ("object" == typeof a || !a) {
            var g = f.extend({checkedClass: j, disabledClass: u, indeterminateClass: k, labelHover: !0}, a),
                h = g.handle, m = g.hoverClass || "hover", y = g.focusClass || "focus", v = g.activeClass || "active",
                z = !!g.labelHover, s = g.labelHoverClass || "hover", B = ("" + g.increaseArea).replace("%", "") | 0;
            ...
            return b.each(function () {
                ...
                var a = f(this), b = this, c = b.id, d =
                    -B + "%", e = 100 + 2 * B + "%", e = {
                        ...
                        border: 0,
                        opacity: 0
                    }, d = G ? {position: "absolute", visibility: "hidden"} : B ? e : {position: "absolute", opacity: 0},
            ...
            init: function () {
                return this.each(function () {
                    var $element = $(this), $div, $switchLeft, $switchRight, $label, $form = $element.closest("form"),
                        myClasses = "", classes = $element.attr("class"), color, moving,
                        onLabel = "<i class='fa fa-check'></i>", offLabel = "<i class='fa fa-times'></i>", icon = false,
                        textLabel = false;
...
!function (d) {
    var h = function (a) {
        this.messages = {
            defaultMessage: "Ошибка значения.",
            type: {
                email: "Это должен быть реальный адрес электронной почты.",
                url: "Должна быть ссылка URL",
                urlstrict: "Должна быть ссылка URL.",
                number: "Должно быть число",
                digits: "Числовое поле",
                dateIso: "Введите дату (ГГГГ-ММ-дд).",
                alphanum: "Должны быть только буквы.",
                phone: "Введите валидный номер телефона."
            },
            notnull: "Недолжно быть пустым.",
            notblank: "Заполните пожалуйста.",
            required: "Обязательное поле",
            regexp: "Ошибка.",
            min: "Должно быть больше или равно %s.",
            max: "Должно быть меньше или равно %s.",
            range: "Это значение должно быть между %s and %s.",
            minlength: "Недостаточно символов. Оно должно содержать %s символов или более",
            maxlength: "Слишком много символов. Должно быть %s значений или меньше.",
            rangelength: "Недопустимое количество символов. Оно должно быть между %s и %s .",
            mincheck: "Вы должны выбрать не менее %s вариантов.",
            maxcheck: "Вы должны выбрать %s вариантов или меньше.",
            rangecheck: "Вы должны выбрать между %s и %s вариантами.",
    ...
    n.prototype = {
        constructor: n, init: function (a) {
            ...
            this.removeErrors();
            this.ParsleyInstance.validatedOnce =
                !1;
            ...
            var a =
                this.options.errorContainer || this.options.errors.container(this.ParsleyInstance.element, this.ParsleyInstance.isRadioOrCheckbox),
    ...
    m.prototype = {
        ...
        bindHtml5Constraints: function () {
            ...
            var b = this.getVal();
            if ("keyup" === a.type && !/keyup/i.test(this.options.trigger) && !this.validatedOnce || "change" === a.type && !/change/i.test(this.options.trigger) && !this.validatedOnce || !this.isRadioOrCheckbox && this.getLength(b) < this.options.validationMinlength &&
    ...
    d.fn.parsley =
        function (a, b) {
            ...
            var e = d(this).data("parsleyNamespace") ? d(this).data("parsleyNamespace") : "undefined" !== typeof a && "undefined" !== typeof a.namespace ?
                a.namespace : d.fn.parsley.defaults.namespace,
    ...
    var i = function () {
        var i = '<div class="colpick"><div class="colpick_color"><div class="colpick_color_overlay1"><div class="colpick_color_overlay2"><div class="colpick_selector_outer"><div class="colpick_selector_inner"></div></div></div></div></div><div class="colpick_hue"><div class="colpick_hue_arrs"><div class="colpick_hue_larr"></div><div class="colpick_hue_rarr"></div></div></div><div class="colpick_new_color"></div><div class="colpick_current_color"></div><div class="colpick_hex_field"><div class="colpick_field_letter">#</div><input type="text" maxlength="6" size="6" /></div><div class="colpick_rgb_r colpick_field"><div class="colpick_field_letter">R</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_rgb_g colpick_field"><div class="colpick_field_letter">G</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_rgb_b colpick_field"><div class="colpick_field_letter">B</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_hsb_h colpick_field"><div class="colpick_field_letter">H</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_hsb_s colpick_field"><div class="colpick_field_letter">S</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_hsb_b colpick_field"><div class="colpick_field_letter">B</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_submit"></div></div>',
            a = {
                ...
                var a = t(i.data("colpick").bornIn), c = a.offset(), e = t(this).offset(),
                    o = a.scrollTop() + e.top + this.offsetHeight, l = e.left - c.left, d = T();
                ...
                return this.each(function () {
                    if (!t(this).data("colpickId")) {
                        ...
                        var d = navigator.userAgent.toLowerCase(),
                            ...
                            m = _ ? parseFloat(d.match(/msie ([0-9]{1,}[\.0-9]{0,})/)[1]) : 0, x = _ && 10 > m,
...
!function (t) {
    ...
    t.fn.extend({
        maxlength: function (e, a) {
            ...
            function u(t, a) {
                var s = d(t), n = m.offset(), o = t.outerWidth(), r = a.outerWidth(), i = a.outerWidth(),
                    l = a.outerHeight(), h = m.scrollTop() + s.top, c = s.left - n.left;
                switch (e.placement) {
                    case"bottom":
    ...
    e.prototype = {
        constructor: e, init: function () {
            ...
            var e = this.multiple ? " show-tick" : "",
                ...
                n = "<div class='btn-group bootstrap-select" + e + "'><button type='button' class='btn dropdown-toggle selectpicker' data-toggle='dropdown'><div class='filter-option pull-left'></div>&nbsp;<div class='caret'></div></button><div class='dropdown-menu open'>" + i + s + "<ul class='dropdown-menu inner selectpicker' role='menu'></ul></div></div>";
            return t(n)
        }, createView: function () {
            ...
            return this.$element.find("option").each(function () {
                var s = t(this), n = s.attr("class") || "", o = s.attr("style") || "",
                    a = s.data("content") ? s.data("content") : s.html(),
                    l = void 0 !== s.data("subtext") ? '<small class="muted text-muted">' + s.data("subtext") + "</small>" : "",
                    d = void 0 !== s.data("icon") ? '<i class="glyphicon ' + s.data("icon") + '"></i> ' : "";
                if ("" !== d && (s.is(":disabled") || s.parent().is(":disabled")) && (d = "<span>" + d + "</span>"), s.data("content") || (a = d + '<span class="text">' + a + l + "</span>"), e.options.hideDisabled && (s.is(":disabled") || s.parent().is(":disabled"))) i.push('<a style="min-height: 0; padding: 0"></a>'); else if (s.parent().is("optgroup") && s.data("divider") !== !0) if (0 == s.index()) {
                    var h = s.parent().attr("label"),
                        r = void 0 !== s.parent().data("subtext") ? '<small class="muted text-muted">' + s.parent().data("subtext") + "</small>" : "",
                        c = s.parent().data("icon") ? '<i class="' + s.parent().data("icon") + '"></i> ' : "";
            ...
            var i = this.$element.find("option:selected").map(function () {
                var i, s = t(this),
                    n = s.data("icon") && e.options.showIcon ? '<i class="glyphicon ' + s.data("icon") + '"></i> ' : "";
            ...
            t.appendTo("body");
            var e = t.addClass("open").find("> .dropdown-menu"), i = e.find("li > a").outerHeight(),
            ...
            var e, i, s, n = this, o = this.$menu, a = o.find(".inner"), l = this.$newElement.outerHeight(),
                d = this.$newElement.data("liHeight"), h = this.$newElement.data("headerHeight"),
                r = this.$newElement.data("searchHeight"), c = o.find("li .divider").outerHeight(!0),
                ...
                u = this.options.hideDisabled ? ":not(.disabled)" : "", f = t(window),
                m = p + parseInt(o.css("margin-top")) + parseInt(o.css("margin-bottom")) + 2, v = function () {
            ...
            if (v(), this.options.header && o.css("padding-top", 0), "auto" == this.options.size) {
                ...
                var $ = o.find("li" + u + " > *").filter(":not(.div-contain)").slice(0, this.options.size).last().parent().index(),
                    w = o.find("li").slice(0, $ + 1).find(".div-contain").length;
...
+function (e) {
    ...
    var t = "Microsoft Internet Explorer" == window.navigator.appName, i = function (t, i) {
        if (this.$element = e(t), this.$input = this.$element.find(":file"), 0 !== this.$input.length) {
            ...
            "inline" != this.$preview.css("display") && "0px" != n && "none" != n, this.original = {
...
!function () {
    ...
    this.jSlider = function () {
        ...
        init: function (e, s) {
            ...
            var i = this, s = this.o.labels[t.uid], n = t.value.prc,
                o = {label: s.o.outerWidth(), right: !1, border: n * this.sizes.domWidth / 100};
            ...
            if (this.settings.limits) {
                ...
                for (key in this.o.pointers) if (!this.settings.single || 0 == key) {
                    var e = this.o.pointers[key], i = this.o.labels[e.uid],
                        s = i.o.offset().left - this.sizes.domOffset.left, n = this.o.limits[0];
...
!function (e) {
    ...
    t.prototype = {
        constructor: t, init: function () {
            ...
            var c = e("<li " + n + "><span>" + l.escapeHTML(o.text()) + "</span></li>"), d = c.clone(), h = o.val(),
                p = l.sanitize(h);
            ...
            if (f.length > 0) {
                var u = f.attr("label"), m = l.sanitize(u), v = l.$selectableUl.find("#optgroup-selectable-" + m),
            ...
            t.value && (t = [t]), e.each(t, function (t, l) {
                if (l.value && 0 === s.$element.find("option[value='" + l.value + "']").length) {
                    var i = e('<option value="' + l.value + '">' + l.text + "</option>"),
                        t = parseInt("undefined" == typeof l.index ? s.$element.children().length : l.index),
                        n = void 0 == l.nested ? s.$element : e("optgroup[label='" + l.nested + "']");
