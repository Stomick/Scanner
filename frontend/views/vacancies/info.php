                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        ...
                        <div class="links_block">
                            ...
                            <?php } else { ?>
                            <?php } ?>
                            <a href="/profile/vacancies/ID<?= $vac->muser_id ?>.html">К списку вакансий</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div style="overflow: hidden; margin: 0 15px 15px; padding: 10px 20px;" class="white_bg_block">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                ...
                <div style="margin-bottom: 30px;">
                    <p>
                        <span>Компания</span>
                        <span><?php if($us = \models\MUser::findOne($vac->muser_id)){ echo $us->company ? $us->company : $us->firstname .' '. $us->lastname;} ?></span>
                    </p>
                    <p>
