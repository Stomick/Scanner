    ...
    <div class="profile_info reviews_index">
        <div style="overflow: hidden; padding: 10px 20px;" class="row white_bg_block">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <h2><?= Yii::$app->user->isGuest || !Yii::$app->user->identity->type ? $user->company : $user->firstname .' '. $user->lastname ?>
                    <div class="rating_reviews_block">
                        <span class="rating_quantity"><?= round(Reviews::getSumRating($user->id, $uType), 2) ?></span>
                        <span>Всего <?= Reviews::getAllRating($user->id, $uType) ?></span>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <img class="info_logo_user" src="<?= Yii::$app->user->isGuest || !Yii::$app->user->identity->type ? $user->comp_logo : $user->logo ?>" alt="logo">
                    </div>
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <?php foreach (array_reverse(Reviews::getRating($user->id, $uType)) as $k => $r) { ?>
