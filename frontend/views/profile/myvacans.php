        ...
        <div class="row">
            <div style="overflow: hidden; margin: 0 15px 15px; padding: 10px 20px 30px;" class="white_bg_block">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <h2>Вакансии
                        <!--                        <a href="/">Поделиться</a>-->
                        <a href="/vacancies/add.html">Добавить <span class="mob_disp_none">вакансию</span></a>
                    </h2>
                </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="link_block">
                        <a class="edit_link" href="/vacancies/edit/ID<?=$vac->id?>.html">Изменить</a>
                        <a class="del_link" href="/vacancies/inarhive/ID<?=$vac->id?>.html">В архив</a>
                    </div>
