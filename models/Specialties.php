...
class Specialties extends ActiveRecord
{
    function __construct($config = [])
    {
        //Specialties::deleteAll(['tmp'=>1, 'muser_id'=>\Yii::$app->user->id]);
    ...
    public function beforeSave($insert)
    {
        ...
        $maker = (MUser::findOne($this->muser_id))->getCountVacansies();
        if ($this->public){
            if($maker <=3) {
    ...
    {
        foreach (Photos::findAll(['type' => 'specialties', 'type_id' => $this->id]) as $k => $p) {
            $p->delete();
        }
