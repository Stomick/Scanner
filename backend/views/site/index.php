...
<?php include Yii::$app->user->identity->role . '-header.php' ?>
<?php include Yii::$app->user->identity->role . '-nav.php' ?>
<?php include Yii::$app->user->identity->role . '-top-serch.php' ?>
...
<script type="text/javascript" src="/plugins/bootstrap/bootstrap.min.js"></script>
<script type="text/javascript" src="/plugins/datable/jquery.dataTables.min.js"></script>
<script type="text/javascript" src="/plugins/datable/dataTables.bootstrap.js"></script>
<script type="text/javascript" src="/js/jquery.min.js"></script>
<script type="text/javascript" src="/js/jquery.ui.min.js"></script>
<script type="text/javascript" src="/plugins/bootstrap/bootstrap.min.js"></script>
...
<script type="text/javascript" src="/plugins/datable/jquery.dataTables.min.js"></script>
<script type="text/javascript" src="/plugins/datable/dataTables.bootstrap.js"></script>
<?php include __DIR__ . '/../' . Yii::$app->user->identity->role . '/' . $page . '/' . $action . '.php' ?>
            ...
            <ul>
                <li>
                    <section class="thumbnail-in">
                        <div class="widget-im-tools tooltip-area pull-right">
                            ...
                            <span>
																		<a href="javascript:void(0)" class="im-delete"
                        ...
                        <div class="im-thumbnail"><img alt="" src="/img/avatar2.png"/></div>
                        <label></label>
                        <div class="pre-text"> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                ...
                <li>
                    <section class="thumbnail-in">
                        ...
                        <div class="im-thumbnail"><img alt="" src="/img/avatar.png"/></div>
                ...
                <li>
                    <section class="thumbnail-in">
                        <div class="widget-im-tools tooltip-area pull-right">
                            ...
                            <span>
																		<a href="javascript:void(0)" class="im-action"
                ...
                <li>
                    <section class="thumbnail-in">
                        <div class="widget-im-tools tooltip-area pull-right">
																<span>
																		<time class="timeago"
                                                                              datetime="2013-11-17T14:24:17Z">timeago</time>
																</span>
                            <span>
																		<a href="javascript:void(0)" class="im-action"
                                                                           data-toggle="tooltip" data-placement="left"
                        ...
                        <div class="pre-text">Two Button (with link and click to close this) Lorem ipsum dolor sit amet,
                ...
                <li>
                    <section class="thumbnail-in">
                        <div class="widget-im-tools tooltip-area pull-right">
																<span>
																		<time class="timeago"
                                                                              datetime="2013-11-17T01:24:17Z">timeago</time>
																</span>
                            <span>
																		<a href="javascript:void(0)" class="im-action"
                                                                           data-toggle="tooltip" data-placement="left"
                    ...
                    <div class="im-confirm-group">
                        <div class=" btn-group btn-group-justified">
                            <a class="btn btn-inverse im-confirm" href="javascript:void(0)" data-confirm="accept">Accept.</a>
                            <a class="btn btn-theme im-confirm" href="javascript:void(0)" data-confirm="actionNow">Fixed
                                now.</a>
                        </div>
                    </div>
                </li>
                <li>
                    <section class="thumbnail-in">
                        <div class="widget-im-tools tooltip-area pull-right">
																<span>
																		<time class="timeago"
                                                                              datetime="2013-09-17T09:24:17Z">timeago</time>
																</span>
                            <span>
																		<a href="javascript:void(0)" class="im-action"
                                                                           data-toggle="tooltip" data-placement="left"
                    ...
                    <div class="im-confirm-group">
                        <div class=" btn-group btn-group-justified">
                            ...
                            <a class="btn btn-theme im-confirm" href="javascript:void(0)" data-confirm="no">Later.</a>
                            <a class="btn btn-danger im-confirm" href="javascript:void(0)"
                               data-confirm="yes">Delete.</a>
                        </div>
                    </div>
                </li>
            </ul>
...
<?php include Yii::$app->user->identity->role . '-menu.php'; ?>
<?php include Yii::$app->user->identity->role . '-menu-right.php'; ?>
