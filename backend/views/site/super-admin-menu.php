...
<nav id="menu">
    <ul>
        <li>
            <a href="/users"><span><i class="icon  fa fa-users"></i>Администраторы</span></a>
        </li>
        <li>
            <a href="/vacancies"><span><i class="icon  fa fa-users"></i>Вакансии</span></a>
        </li>
        <li>
            <a href="/works"><span><i class="icon  fa fa-users"></i>Специальности</span></a>
        </li>
        <li>
            <span><i class="icon  fa fa-users"></i>Пользователи</span>
            <ul>
                <li><a href="/musers/executer"><i class="icon  fa fa-rocket"></i>Работники</a></li>
                <li><a href="/musers/customer"><i class="icon  fa fa-th"></i>Наниматели</a></li>
            </ul>
        </li>
        <li>
            <a href="/categories"><span><i class="icon  fa fa-list"></i>Основные Категории</span></a>
        </li>
        <li>
            <a href="/article"><span><i class="icon  fa fa-list"></i>Статьи</span></a>
        </li>
        <!--
