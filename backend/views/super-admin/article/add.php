                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="post" id="fcatadd" data-collabel="3" data-alignlabel="left">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="text" name="Article[title]" class="form-control rounded" required/>
                                </div>
                            </div>
                            <div class="form-group">
                                <textarea cols="80" required id="editorCk" name="Article[text]" rows="10" style="visibility: hidden; display: none;"></textarea>
                            </div>
                            <div class="form-group offset">
                                <div>
                                    <button type="button" id="addcat" class="btn btn-theme">Добавить</button>
