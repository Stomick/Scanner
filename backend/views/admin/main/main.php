                ...
                <div class="widget-timeline">
                    <ul>
                        ...
                        <li class="right animated" data-effect="fadeInLeft">
                            <section>
                                <div class="mark bgimg" style="background-image: url(/photos_preview/300/city/1.jpg)"></div>
                        ...
                        <li class="left">
                            <section>
                                ...
                                <img alt="" src="/photos_preview/700/nature/1.jpg" />
                            </section>
                        </li>
                ...
                <section class="panel">
                    <div class="widget-friend clearfix">
                        <ul class="circle clearfix">
                            ...
                            <li class="online" title="zicdemo"><img alt="" src="/img/avatar.png"></li>
                            <li class="online"><img alt="" src="/img/avatar2.png"></li>
                            <li><img alt="" src="/img/avatar3.png"></li>
                            <li class="online"><img alt="" src="/img/avatar4.png"></li>
                            <li ><img alt="" src="/img/avatar5.png"></li>
                            <li class="busy"><img alt="" src="/img/avatar6.png"></li>
                            <li class="online"><img alt="" src="/photos_preview/50/people/1.jpg"></li>
                            <li class="online"><img alt="" src="/photos_preview/50/people/2.jpg"></li>
                    ...
                    <div class="widget-chat">
                        ...
                        <div class="chat-body">
                            <dl class="chat">
                                ...
                                <dd class="from">
                                    <p>Funny names?</p>
                                    <img alt="" src="/img/avatar2.png" class="avatar circle">
                                </dd>
                                <dd class="to">
